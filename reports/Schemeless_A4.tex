...
\textbf{Comparative Results Summary:}
\begin{table}[H]
\centering
\begin{tabular}{l r r r r}
\toprule
...
\subsection{Discussion: Overhead vs Value}
...
Detailed Docker instructions are provided in \href{https://github.com/Kaushal845/Database_1/blob/main/DOCKER_SETUP.md}{\texttt{DOCKER\_SETUP.md}}.
...
\begin{itemize}
	...
	\item Query history is currently maintained in memory at the API layer, so it is cleared when the service restarts.
\end{itemize}
